...
<body>
    ...
    <form id="payment-form">
        <input type="text" style="display: none;" id="order-id" value="<?php echo $_GET['orderID']?>">
        ...
        <input type="text" id="cvv" value="123" placeholder="CVV" required>
            ...
            <h2 for="amount">Amount: € <?php echo $_GET['amount']?></h2>
        <input type="text" id="amount" style="display: none;" placeholder="Amount" value="<?php echo $_GET['amount']?>" required>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            submitButton.addEventListener("click", function () {
                ...
                if (paymentSuccess) {
                    $.ajax({
                    url: 'controllers/order_controller.php?orderid='+orderID,
                    type: 'GET',
                    data: { type: 'Paid', orderID: orderID},
