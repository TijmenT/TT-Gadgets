 ...
 .
      ...
      <div class="slideshow">
        ...
        <div id="image2" class="fade">
          <img src="img/rD1eOT.jpeg" class="background--container" width="100%" alt="background">
        </div>
        <div id="image3" class="fade">
          <img src="img/turtle-beach-stealth-pro-preorder-blogroll-1679582803054_vcah.jpeg" class="background--container" width="100%" alt="background">
        </div>
      </div>
